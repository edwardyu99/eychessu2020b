...
// 20191126 - 2019q try 8 byte hashstruct, 14bit hval -8192 to +8191
// 20191121 - 2019p change to template quiescheck()
// 20191116 - 2019o optimize score_attk, change to template search()
// 20191109 - 2019n cann-rook-xxx-king 
// 20191106 - 2019m 
// 20191105 - 2019l pointtable, VP, score, bonus, etc, x10. INF=20480. remove threat in engine.cpp
// 20191017 - 2019i remove mate-killer 
// 20191015 - 2019h WIN64 assume POPCNT_CPU
// 20191010 - 2019g sf10 futility moveCountPruning, add countermove
// 20191006 - 2019f sf10 razor
...
//int centrehorse, endcenhorse; //aft clop 58 16
//int futfact1, futfact2; //bef clop 35,10
//int mvcntfact1, mvcntfact2, mvcntfact3, mvcntfact4; //2.4, 0.74, 5.0, 1.00 (sf10) //2.5, 0.73, 3.3, 0.81
//int PawnValueEg; //sf10 208 
int mf;
int mf2;
int mf3;
int MAXQDEPTH;
...
// printf("*** parm1=%d, parm2=%d, parm3=%d\n",mf, mf2, mf3);
// PawnValueEg = GetPrivateProfileInt("param","PawnValueEg",16,inifile);  //0-16 default 8 clop=5
// mvcntfact1 = GetPrivateProfileInt("param","mvcntfact1",24,inifile);  //2-46   default 24 clop=??
// mvcntfact2 = GetPrivateProfileInt("param","mvcntfact2",74,inifile);  //20-130 default 74 clop=??
// mvcntfact3 = GetPrivateProfileInt("param","mvcntfact3",50,inifile);  //2-98   default 50 clop=??
// mvcntfact4 = GetPrivateProfileInt("param","mvcntfact4",100,inifile); //20-180 default 100 clop=??
// futfact1 = GetPrivateProfileInt("param","futfact1",35,inifile);  //20-50 default 35 clop=??
// futfact2 = GetPrivateProfileInt("param","futfact2",10,inifile);  // 0-20 default 10 clop=??
// centrehorse = GetPrivateProfileInt("param","centrehorse",58,inifile);  //48-68 default 58 clop=58
// endcenhorse = GetPrivateProfileInt("param","endcenhorse",16,inifile);  //0-45 default 18 clop=16
