...
//20190917 setup EYCHESSU.INI for clop in \real 
	...
	ini_NBOOK = GetPrivateProfileInt("param","param1",24,inifile);  //3-60 default 24 
...
//	char *BackSlashPtr;
	...
	MoveStruct moveS;
#ifdef _WIN64
	printf("Eychessu64 2.893a (logical NCORE=%d, popcnt=%d) by Edward Yu\n", NCORE, POPCNT_CPU);
#else	
...
//#endif    
		...
		// ��ʾ��������ơ��汾�����ߺ�ʹ����
#ifdef _WIN64		
		printf ("id name Eychessu64 V2.893a\n"); fflush(stdout);
#else		
