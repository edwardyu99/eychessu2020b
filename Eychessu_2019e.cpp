...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 20190927 - 2019e try to ref stockfish 10 source for improvement
...
//	char *BackSlashPtr;
	...
	MoveStruct moveS;
#ifdef _WIN64
	printf("Eychessu64 2019e (logical NCORE=%d, popcnt=%d) by Edward Yu\n", NCORE, POPCNT_CPU);
#else	
	printf("Eychessu 2019e (logical NCORE=%d, popcnt=%d) by Edward Yu\n", NCORE, POPCNT_CPU);
#endif	
	fflush(stdout);
...
//#endif    
		...
		//显示引擎的名称、版本、作者和使用者
#ifdef _WIN64		
		printf ("id name Eychessu64 V2019e\n"); fflush(stdout);
#else		
    printf ("id name Eychessu V2019e\n"); fflush(stdout);
#endif
